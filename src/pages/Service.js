...
const Service = () => {
  return (
    <>
      <main>
        <div className="relative h-[250px] bg-gray-100 mt-[10px] p-[20px]">
          <div class="w-full max-w-sm min-w-[200px] ml-[100px]">
          <h1 className=' text-[50px] text-gray-700 pb-[10px]'>Search for a class</h1>
